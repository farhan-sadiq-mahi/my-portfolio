...
import img1 from '../assets/footerImg/man.png'
import img2 from '../assets/footerImg/project.png'
import img3 from '../assets/footerImg/skills.png'
import img4 from '../assets/footerImg/contact.png'
    ...
    return (
        <div className='border-2 bg-gray-900 bg-opacity-90 border-pink-500 fixed bottom-0 w-full flex items-center justify-around'>
            ...
            gap-1 onCursor border-pink-500 border-2 px-5 py-2 text-pink-500'>
                    <img src={img2} alt="Projects" className='w-6' />
            ...
            gap-1 onCursor border-pink-500 border-2 px-5 py-2 text-pink-500'>
                    <img src={img3} alt="Projects" className='w-6' />
            ...
            gap-1 onCursor border-pink-500 border-2 px-5 py-2 text-pink-500'>
                    <img src={img4} alt="Projects" className='w-6' />
